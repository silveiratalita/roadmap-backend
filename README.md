# Roadmap para Migração de Carreira: Desenvolvedor Backend

Este roadmap foi criado especialmente para pessoas em transição de carreira, considerando uma dedicação de 2 horas diárias de estudo. 
